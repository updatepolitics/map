...
exports.clearDb = function(doneClearDb) {
  async.series([function(cb){
    ...
    app.models.HubNature.deleteAll(cb);
  }, function(cb) {
...
exports.importHubNature = function(doneImportHubNature){
  var HubNature = app.models.HubNature;
  ...
  async.eachSeries(data, function(item, doneEach){
    var nature = new HubNature({
      name_pt: item[0],
      plural: item[1],
      institutional: item[2]
    });

    nature.save(function(err){
      hubNatureIds[item[0]] = nature.toJSON();
      doneEach(err);
    });
  }, doneImportHubNature);
}
...
exports.importHubs = function(doneImportHubs){
  ...
  function importHub(record, doneParseHub) {
    ...
    var hubNature = hubNatureIds[record['Natureza (Hub)']] || hubNatureIds[record['coletivo']];
    if (hubNature && hubNature.id) record['natureId'] = hubNature.id;
...
exports.importMethods = function(doneImportMethods) {
