window.onload = function (){
	...
	function load(){
		...
		create_filters(json.filters.method);
		create_filters(json.filters.kind);
		create_filters(json.filters.coverage);
		create_filters(json.filters.purpose);
		create_filters(json.filters.type);
		create_filters(json.filters.origin);
